...
let
  ...
  commonArgs =
    let
      neopilotCargoLock = builtins.fromTOML (builtins.readFile ../crates/neopilot/Cargo.toml);
      stdenv' = stdenv;
    in
    rec {
      pname = "neopilot-editor";
      version = neopilotCargoLock.package.version + "-nightly";
      src = builtins.path {
        path = ../.;
      ...
      cargoExtraArgs = "-p neopilot -p cli --locked --features=gpui/runtime_shaders";
      ...
      env = {
        ...
        NEOPILOT_UPDATE_EXPLANATION = "Neopilot has been installed using Nix. Auto-updates have thus been disabled.";
...
craneLib.buildPackage (
  lib.recursiveUpdate commonArgs {
    ...
    # https://github.com/khulnasoft-lab/neopilot/issues/19971#issuecomment-2688455390
    ...
    preBuild = ''
      ...
      echo nightly > crates/neopilot/RELEASE_CHANNEL
    '';
    ...
    installPhase =
      if stdenv.hostPlatform.isDarwin then
        ''
          ...
          # Neopilot expects git next to its own binary
          ...
          ln -s "$out/Applications/Neopilot Nightly.app/Contents/MacOS/cli" $out/bin/neopilot
        ...
        ''
          ...
          cp $TARGET_DIR/neopilot $out/libexec/neopilot-editor
          cp $TARGET_DIR/cli  $out/bin/neopilot
          ln -s $out/bin/neopilot $out/bin/neopilotitor  # home-manager expects the CLI binary to be here


          install -D "crates/neopilot/resources/app-icon-nightly@2x.png" \
            "$out/share/icons/hicolor/1024x1024@2x/apps/neopilot.png"
          install -D crates/neopilot/resources/app-icon-nightly.png \
            $out/share/icons/hicolor/512x512/apps/neopilot.png

          # TODO: icons should probably be named "neopilot-nightly"
          (
            ...
            ${lib.getExe envsubst} < "crates/neopilot/resources/neopilot.desktop.in" > "$out/share/applications/dev.neopilot.Neopilot-Nightly.desktop"
          )
    ...
    postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
      wrapProgram $out/libexec/neopilot-editor --suffix PATH : ${lib.makeBinPath [ nodejs_22 ]}
    '';

    meta = {
      description = "High-performance, multiplayer code editor from the creators of Atom and Tree-sitter";
      homepage = "https://neopilot.dev";
      changelog = "https://neopilot.dev/releases/preview";
      license = lib.licenses.gpl3Only;
      mainProgram = "neopilot";
