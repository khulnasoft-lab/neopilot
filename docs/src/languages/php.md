...
PHP support is available through the [PHP extension](https://github.com/neopilot-extensions/php).
...
The Neopilot PHP Extension can install `phpactor` automatically but requires `php` to installed and available in your path:
...
Neopilot supports syntax highlighting for PHPDoc comments.
