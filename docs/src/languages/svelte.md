...
Svelte support is available through the [Svelte extension](https://github.com/neopilot-extensions/svelte).
...
Neopilot sets the following initialization options for inlay hints:
...
to make the language server send back inlay hints when Neopilot has them enabled in the settings.
