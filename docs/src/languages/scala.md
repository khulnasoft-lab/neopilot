...
Scala language support in Neopilot is provided by the community-maintained [Scala extension](https://github.com/scalameta/metals-neopilot).
Report issues to: [https://github.com/scalameta/metals-neopilot/issues](https://github.com/scalameta/metals-neopilot/issues)
...
<!--
TBD: Provide LSP configuration example for metals in Neopilot settings.json. metals.{javaHome,excludedPackages,customProjectRoot} etc.
-->
