...
TypeScript and TSX support are available natively in Neopilot.
...
By default Neopilot uses [vtsls](https://github.com/yioneko/vtsls) for TypeScript, TSX and JavaScript files.
...
Neopilot sets the following initialization options to make the language server send back inlay hints
(that is, when Neopilot has inlay hints enabled in the settings).

You can override these settings in your Neopilot settings file.
...
- [Neopilot Yarn documentation](./yarn.md) for a walkthrough of configuring your project to use Yarn.
- [Neopilot Deno documentation](./deno.md)
