...
R support is available through the [R extension](https://github.com/ocsmit/neopilot-r).
...
3. Install the [R Neopilot extension](https://github.com/ocsmit/neopilot-r) through Neopilot's extensions manager.
...
To use the Neopilot REPL with R you need to install [Ark](https://github.com/posit-dev/ark), an R Kernel for Jupyter applications.
