...
Deno support is available through the [Deno extension](https://github.com/neopilot-extensions/deno).
...
See [Configuring supported languages](../configuring-languages.md) in the Neopilot documentation for more information.
