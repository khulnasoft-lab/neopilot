...
Lua support is available through the [Lua extension](https://github.com/neopilot-extensions/lua).
...
To use [LÖVE (Love2D)](https://love2d.org/) in Neopilot, checkout [LuaCATS/love2d](https://github.com/LuaCATS/love2d) into a folder called `love2d-luacats` into the parent folder of your project:
...
To use [Playdate Lua SDK](https://play.date/dev/) in Neopilot, checkout [playdate-luacats](https://github.com/notpeter/playdate-luacats) into the parent folder of your project:
...
To enable [Inlay Hints](../configuring-languages#inlay-hints) for LuaLS in Neopilot

1. Add the following to your Neopilot settings.json:
...
To enable auto-formatting with your LuaLS (provided by [CppCXY/EmmyLuaCodeStyle](https://github.com/CppCXY/EmmyLuaCodeStyle)) make sure you have `"format.enable": true,` in your .luarc.json add the following to your Neopilot `settings.json`:
