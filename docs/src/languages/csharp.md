...
C# support is available through the [C# extension](https://github.com/neopilot-extensions/csharp).
...
The `OmniSharp` binary can be configured in a Neopilot settings file with:
