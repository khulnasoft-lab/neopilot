...
You can configure which `clangd` binary Neopilot should use.
...
If you want to disable Neopilot looking for a `clangd` binary, you can set `ignore_system_version` to `true`:
