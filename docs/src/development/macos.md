...
- Follow the steps in the [collab README](https://github.com/khulnasoft-lab/neopilot/blob/main/crates/collab/README.md) to configure the Postgres database for integration tests
...
```sh
error: failed to run custom build command for gpui v0.1.0 (/Users/path/to/neopilot)`**
...
If you are building Neopilot a lot, you may find that macOS continually verifies new
