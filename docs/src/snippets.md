...
The snippets are located in `~/.config/neopilot/snippets` directory to which you can navigate to with the {#action snippets::OpenFolder} action.
...
For more configuration information, see the [`simple-completion-language-server` instructions](https://github.com/khulnasoft-lab/simple-completion-language-server/tree/main).
