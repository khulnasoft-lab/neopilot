...
wasmtime::component::bindgen!({
    ...
    with: {
        ...
        "neopilot:extension/common": latest::neopilot::extension::common,
        "neopilot:extension/github": latest::neopilot::extension::github,
        "neopilot:extension/http-client": latest::neopilot::extension::http_client,
        "neopilot:extension/lsp": latest::neopilot::extension::lsp,
        "neopilot:extension/nodejs": latest::neopilot::extension::nodejs,
        "neopilot:extension/platform": latest::neopilot::extension::platform,
        "neopilot:extension/process": latest::neopilot::extension::process,
        "neopilot:extension/slash-command": latest::neopilot::extension::slash_command,
        "neopilot:extension/context-server": latest::neopilot::extension::context_server,
    },
});
