...
/// The content of a serialineopilot theme family.
...
/// The content of a serialineopilot theme.
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
...
pub struct ThemeColorsContent {
    ...
    /// special attention. Usually a document highlight is visualineopilot by changing
