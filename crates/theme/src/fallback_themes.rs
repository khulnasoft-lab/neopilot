...
/// The default theme family for Neopilot.
///
...
pub fn neopilot_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "neopilot-default".to_string(),
        name: "Neopilot Default".into(),
        author: "".into(),
        themes: vec![neopilot_default_dark()],
...
pub(crate) fn neopilot_default_dark() -> Theme {
