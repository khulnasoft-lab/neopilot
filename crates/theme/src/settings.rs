use crate::fallback_themes::neopilot_default_dark;
use crate::{
...
/// Note: This setting is still experimental. See [this tracking issue](https://github.com/khulnasoft-lab/neopilot/issues/18078)
...
pub struct ThemeSettingsContent {
    ...
    /// The name of the Neopilot theme to use.
    #[serde(default)]
    ...
    fn load(sources: SettingsSources<Self::FileContent>, cx: &mut App) -> Result<Self> {
        ...
        let mut this = Self {
            ...
            active_theme: themes
                ...
                .or(themes.get(&neopilot_default_dark().name))
                .unwrap(),
