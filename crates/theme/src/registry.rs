...
impl ThemeRegistry {
    ...
    pub fn new(assets: Box<dyn AssetSource>) -> Self {
        ...
        // We're loading the Neopilot default theme, as we need a theme to be loaded
        // for tests.
        registry.insert_theme_families([crate::fallback_themes::neopilot_default_themes()]);
    ...
    /// Loads the themes bundled with the Neopilot binary and adds them to the registry.
