//! The Neopilot Rust Extension API allows you write extensions for [Neopilot](https://neopilot.dev/) in Rust.
...
pub use wit::{
    ...
    neopilot::extension::context_server::ContextServerConfiguration,
    neopilot::extension::dap::{
    ...
    neopilot::extension::github::{
        GithubRelease, GithubReleaseAsset, GithubReleaseOptions, github_release_by_tag_name,
        latest_github_release,
    },
    neopilot::extension::nodejs::{
        node_binary_path, npm_install_package, npm_package_installed_version,
        npm_package_latest_version,
    },
    neopilot::extension::platform::{Architecture, Os, current_platform},
    neopilot::extension::slash_command::{
...
pub mod lsp {
    pub use crate::wit::neopilot::extension::lsp::{
        Completion, CompletionKind, InsertTextFormat, Symbol, SymbolKind,
    };
}

/// A result returned from a Neopilot extension.
...
/// Registers the provided type as a Neopilot extension.
///
...
macro_rules! register_extension {
    ($extension_type:ty) => {
        ...
        pub extern "C" fn __init_extension() {
            ...
            neopilot_extension_api::register_extension(|| {
                Box::new(<$extension_type as neopilot_extension_api::Extension>::new())
            });
        }
    };
}
...
#[unsafe(link_section = "neopilot:api-version")]
#[doc(hidden)]
pub static NEOPILOT_API_VERSION: [u8; 6] =
