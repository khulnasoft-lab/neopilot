...
pub const DOCS_URL: &str = "https://neopilot.dev/docs/";
...
impl Render for WelcomePage {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let edit_prediction_provider_is_neopilot =
            all_language_settings(None, cx).edit_predictions.provider
                == EditPredictionProvider::Neopilot;

        let edit_prediction_label = if edit_prediction_provider_is_neopilot {
                        ...
                        v_flex()
                            ...
                            .child(
                                h_flex()
                                    .w_full()
                                    .justify_center()
                                    .child(Headline::new("Welcome to Neopilot")),
                            )
                            .child(
                        ...
                        h_flex()
                            ...
                            .child(
                                v_flex()
                                            ...
                                            .on_click(cx.listener(|this, _, window, cx| {
                                                ...
                                                this.workspace
                                                    .update(cx, |_workspace, cx| {
                                                        window.dispatch_action(neopilot_actions::theme_selector::Toggle::default().boxed_clone(), cx);
                                                    })
                                                    .ok();
                                            })),
                                    )
                                    ...
                                    .child(
                                        Button::new(
                                            "try-neopilot-edit-prediction",
                                            edit_prediction_label,
                                        )
                                        .disabled(edit_prediction_provider_is_neopilot)
                                        .icon(IconName::NeopilotPredict)
                                        .icon_size(IconSize::XSmall)
                                        .icon_color(Color::Muted)
                                        .icon_position(IconPosition::Start)
                                        .on_click(
                                            cx.listener(|_, _, window, cx| {
                                                ...
                                                window.dispatch_action(neopilot_actions::OpenNeopilotPredictOnboarding.boxed_clone(), cx);
                                            }),
                                        ),
                                    )
                                    .child(
                                    ...
                                    .child(
                                        Button::new("explore-extensions", "Explore Extensions")
                                            ...
                                            .on_click(cx.listener(|_, _, window, cx| {
                                                ...
                                                window.dispatch_action(Box::new(
                                                    neopilot_actions::Extensions::default(),
                                                ), cx);
                                            })),
                                    )
                            ),
