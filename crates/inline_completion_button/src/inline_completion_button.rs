...
use neopilot_actions::OpenBrowser;
...
impl Render for InlineCompletionButton {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        match all_language_settings.edit_predictions.provider {
            ...
            EditPredictionProvider::Copilot => {
                ...
                div().child(
                    PopoverMenu::new("copilot")
                        .menu(move |window, cx| {
                            Some(match status {
                                Status::Authorineopilot => this.update(cx, |this, cx| {
            ...
            EditPredictionProvider::Neopilot => {
                let enabled = self.editor_enabled.unwrap_or(true);

                let zeta_icon = if enabled {
                    IconName::NeopilotPredict
                } else {
                    IconName::NeopilotPredictDisabled
                };
                ...
                if !has_subscription || !current_user_terms_accepted.unwrap_or(false) {
                    ...
                    return div().child(
                        IconButton::new("neopilot-predict-pending-button", zeta_icon)
                            ...
                            .on_click(cx.listener(move |_, _, window, cx| {
                                ...
                                window.dispatch_action(
                                    neopilot_actions::OpenNeopilotPredictOnboarding.boxed_clone(),
                                    cx,
                                );
                            })),
                    );
                ...
                let icon_button = IconButton::new("neopilot-predict-pending-button", zeta_icon)
                    .shape(IconButtonShape::Square)
                    .when(
...
impl InlineCompletionButton {
    ...
    pub fn build_language_settings_menu(
        ...
        if matches!(provider, EditPredictionProvider::Neopilot) {
            menu = menu
                .separator()
                            ...
                            v_flex()
                                ...
                                .child(
                                    Label::new(indoc!{
                                        ...
                                        Neopilot must detect a license file in your repo for this setting to take effect."
                                    })
                                )
                                .child(
                                    h_flex()
        ...
        menu = menu.item(
            ContextMenuEntry::new("Configure Excluded Files")
                ...
                .documentation_aside(DocumentationSide::Left, |_| {
                    Label::new(indoc!{"
                        Open your settings to add sensitive paths for which Neopilot will never predict edits."}).into_any_element()
                })
                .handler(move |window, cx| {
        ...
        if !self.editor_enabled.unwrap_or(true) {
            menu = menu.item(
                ContextMenuEntry::new("This file is excluded.")
                    .disabled(true)
                    .icon(IconName::NeopilotPredictDisabled)
                    .icon_size(IconSize::Small),
            );
        }
                ...
                .and_then(|provider| provider.usage(cx))
            {
                ...
                menu = menu
                    .custom_entry(
                        ...
                        |_window, cx| cx.open_url(&neopilot_urls::account_url(cx)),
                    )
                    .entry(
                        "You need to upgrade to Neopilot Pro or contact us.",
                        None,
                        |_window, cx| cx.open_url(&neopilot_urls::account_url(cx)),
                    )
                    .separator();
                ...
                menu = menu
                    ...
                    .entry(
                        "Check your payment status or contact us at billing-support@neopilot.dev to continue using this feature.",
                        None,
                        |_window, cx| {
                            cx.open_url(&neopilot_urls::account_url(cx))
                        },
