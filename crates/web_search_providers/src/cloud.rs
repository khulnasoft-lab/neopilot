...
pub const NEOPILOT_WEB_SEARCH_PROVIDER_ID: &'static str = "neopilot.dev";

impl WebSearchProvider for CloudWebSearchProvider {
    fn id(&self) -> WebSearchProviderId {
        WebSearchProviderId(NEOPILOT_WEB_SEARCH_PROVIDER_ID.into())
    }
...
async fn perform_web_search(
    ...
    let request = http_client::Request::builder()
        ...
        .uri(
            http_client
                .build_neopilot_llm_url("/web_search", &[])?
                .as_ref(),
        )
