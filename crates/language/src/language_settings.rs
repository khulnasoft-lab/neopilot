...
pub struct LanguageSettings {
    ...
    /// Neopilot's Prettier integration settings.
...
impl LanguageSettings {
    ...
    /// Returns the customineopilot list of language servers from the list of
    /// available language servers.
    pub fn customineopilot_language_servers(
        &self,
...
impl EditPredictionProvider {
    pub fn is_neopilot(&self) -> bool {
        match self {
            EditPredictionProvider::Neopilot => true,
...
pub struct LanguageSettingsContent {
    ...
    /// when you type (, Neopilot will automatically add a closing ) at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type (, Neopilot will automatically surround text with ().
    ///
    /// Default: true
...
pub enum SelectedFormatter {
    /// Format files using Neopilot's Prettier integration (if applicable),
...
pub enum Formatter {
    ...
    /// Format code using Neopilot's Prettier integration.
    Prettier,
