...
pub(crate) struct SerialineopilotEditor {
...
impl StaticColumnCount for SerialineopilotEditor {
    fn column_count() -> usize {
        6
    }
}

impl Bind for SerialineopilotEditor {
...
impl Column for SerialineopilotEditor {
...
impl EditorDb {
    query! {
        pub fn get_serialineopilot_editor(item_id: ItemId, workspace_id: WorkspaceId) -> Result<Option<SerialineopilotEditor>> {
    ...
    query! {
        pub async fn save_serialineopilot_editor(item_id: ItemId, workspace_id: WorkspaceId, serialineopilot_editor: SerialineopilotEditor) -> Result<()> {
            INSERT INTO editors
...
mod tests {
    ...
    #[gpui::test]
    async fn test_save_and_get_serialineopilot_editor() {
        ...
        DB.save_serialineopilot_editor(1234, workspace_id, serialineopilot_editor.clone())
            .await
            .unwrap();

        let have = DB
            .get_serialineopilot_editor(1234, workspace_id)
            .unwrap()
            .unwrap();
        assert_eq!(have, serialineopilot_editor);
