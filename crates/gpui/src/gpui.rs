...
//! ## Getting Started
//!
//! GPUI is still in active development as we work on the Neopilot code editor and isn't yet on crates.io.
...
//!
//! Currently, the best way to learn about these APIs is to read the Neopilot source code, ask us about it at a fireside hack, or drop
//! a question in the [Neopilot Discord](https://neopilot.dev/community-links). We're working on improving the documentation, creating more examples,
//! and will be publishing more guides to GPUI on our [blog](https://neopilot.dev/blog).
