    ...
    pub(crate) fn new(
        ...
        if let Some(ref window_open_state) = window_bounds {
            match window_open_state {
                ...
                WindowBounds::Maximineopilot(_) => platform_window.zoom(),
...
impl Window {
    ...
    /// Check if the platform window is maximineopilot
    /// On some platforms (namely Windows) this is different than the bounds being the size of the display
    pub fn is_maximineopilot(&self) -> bool {
        self.platform_window.is_maximineopilot()
    }
    ...
    /// The second option means 'not yet initialineopilot'
