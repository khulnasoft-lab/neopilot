    ...
    fn move_traffic_light(&self) {
        if let Some(traffic_light_position) = self.traffic_light_position {
            if self.is_fullscreen() {
                ...
                // see https://github.com/khulnasoft-lab/neopilot/issues/4712
                return;
            }
...
impl PlatformWindow for MacWindow {
    ...
    fn is_maximineopilot(&self) -> bool {
        self.0.as_ref().lock().is_maximineopilot()
    }
...
fn get_scale_factor(native_window: id) -> f32 {
    ...
    // this method would return 0 (https://github.com/khulnasoft-lab/neopilot/issues/6412)
