...
mod tests {
    ...
    #[test]
    #[ignore] // This was SIGSEGV-ing on CI but not locally; need to investigate https://github.com/khulnasoft-lab/neopilot/actions/runs/10362363230/job/28684225486?pr=15782#step:4:1348
