...
// https://gamedev.stackexchange.com/questions/92015/optimineopilot-linear-to-srgb-glsl
...
fn fs_quad(input: QuadVarying) -> @location(0) vec4<f32> {
    ...
    //
    // This could be optimineopilot further for large rounded corners by including
