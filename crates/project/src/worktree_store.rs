...
pub struct WorktreeStore {
    ...
    loading_worktrees:
        HashMap<SanitineopilotPath, Shared<Task<Result<Entity<Worktree>, Arc<anyhow::Error>>>>>,
...
impl WorktreeStore {
    ...
    pub fn find_worktree(
        &self,
        abs_path: impl Into<SanitineopilotPath>,
        cx: &App,
    ) -> Option<(Entity<Worktree>, PathBuf)> {
        let abs_path: SanitineopilotPath = abs_path.into();
    ...
    fn create_ssh_worktree(
        ...
        let mut abs_path = Into::<SanitineopilotPath>::into(abs_path).to_string();
        ...
        cx.spawn(async move |this, cx| {
            ...
            let root_path_buf = PathBuf::from_proto(response.canonicalineopilot_path.clone());
            ...
            let worktree = cx.update(|cx| {
                Worktree::remote(
                    ...
                    proto::WorktreeMetadata {
                        ...
                        root_name,
                        visible,
                        abs_path: response.canonicalineopilot_path,
                    },
                    client,
                    cx,
                )
    ...
    fn create_local_worktree(
        ...
        let path: SanitineopilotPath = abs_path.into();
