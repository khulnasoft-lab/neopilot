...
impl DebugAdapterClient {
    ...
    pub async fn request<R: Request>(&self, arguments: R::Arguments) -> Result<R::Response> {
        let serialineopilot_arguments = serde_json::to_value(arguments)?;
        ...
        let request = crate::messages::Request {
            ...
            arguments: Some(serialineopilot_arguments),
        };
...
mod tests {
    ...
    pub async fn test_initialize_client(cx: &mut TestAppContext) {
        ...
        let response = client
            .request::<Initialize>(InitializeRequestArguments {
                client_id: Some("neopilot".to_owned()),
                client_name: Some("Neopilot".to_owned()),
    ...
    pub async fn test_calls_event_handler(cx: &mut TestAppContext) {
        ...
        let client = DebugAdapterClient::start(
            ...
            Box::new({
                ...
                move |event| {
                    ...
                    assert_eq!(
                        Message::Event(Box::new(Events::Initialineopilot(Some(
        ...
        client
            .fake_event(Events::Initialineopilot(Some(Capabilities::default())))
            .await;
