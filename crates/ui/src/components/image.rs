                ...
                .children(vec![
                    example_group_with_title(
                        ...
                        vec![
                            single_example(
                                "Default",
                                Vector::square(VectorName::NeopilotLogo, rems(8.))
                                    .into_any_element(),
                            ),
                            single_example(
                                "Custom Size",
                                Vector::new(VectorName::NeopilotLogo, rems(12.), rems(6.))
                                    .into_any_element(),
                            ),
                        ],
                    ),
                    ...
                    example_group_with_title(
                        ...
                        vec![
                            ...
                            single_example(
                                "Neopilot X Copilot",
                                Vector::square(VectorName::NeopilotXCopilot, rems(8.))
                                    .into_any_element(),
                            ),
                        ],
                    ),
...
mod tests {
    ...
    fn vector_path() {
        assert_eq!(
            VectorName::NeopilotLogo.path().as_ref(),
            "images/neopilot_logo.svg"
        );
    }
}
