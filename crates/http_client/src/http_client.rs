...
impl HttpClientWithUrl {
    ...
    /// Builds a Neopilot API URL using the given path.
    pub fn build_neopilot_api_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        let base_url = self.base_url();
        let base_api_url = match base_url.as_ref() {
            "https://neopilot.dev" => "https://api.neopilot.dev",
            "https://staging.neopilot.dev" => "https://api-staging.neopilot.dev",
    ...
    /// Builds a Neopilot LLM URL using the given path.
    pub fn build_neopilot_llm_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        let base_url = self.base_url();
        let base_api_url = match base_url.as_ref() {
            "https://neopilot.dev" => "https://llm.neopilot.dev",
            "https://staging.neopilot.dev" => "https://llm-staging.neopilot.dev",
