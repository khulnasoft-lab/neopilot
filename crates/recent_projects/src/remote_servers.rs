...
impl RemoteServerProjects {
    ...
    fn render_ssh_project(
        ...
        let is_from_neopilot = server.is_from_neopilot();
        ...
        div()
            ...
            .child(
                ListItem::new((element_id_base, ix))
                    ...
                    .when(is_from_neopilot, |server_list_item| {
                                ...
                                h_flex()
                                    ...
                                    .child(
                                        Button::new("learn-more", "Learn more…")
                                            ...
                                            .on_click(|_, _, cx| {
                                                cx.open_url(
                                                    "https://neopilot.dev/docs/remote-development",
                                                );
                                            }),
                                    ),
                            )
