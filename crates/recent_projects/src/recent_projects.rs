...
use workspace::{
    CloseIntent, HistoryManager, ModalView, OpenOptions, SerialineopilotWorkspaceLocation,
    WORKSPACE_DB, Workspace, WorkspaceId,
};
...
pub struct RecentProjectsDelegate {
    ...
    workspaces: Vec<(WorkspaceId, SerialineopilotWorkspaceLocation)>,
...
impl RecentProjectsDelegate {
    ...
    pub fn set_workspaces(
        ...
        self.has_any_non_local_projects = !self
            .workspaces
            .iter()
            .all(|(_, location)| matches!(location, SerialineopilotWorkspaceLocation::Local(_, _)));
    }
}
                ...
                .update(cx, |workspace, cx| {
                    if workspace.database_id() == Some(*candidate_workspace_id) {
                        ...
                        match candidate_workspace_location {
                            SerialineopilotWorkspaceLocation::Local(paths, _) => {
                    ...
                    h_flex()
                        ...
                        .when(self.has_any_non_local_projects, |this| {
                            this.child(match location {
                                SerialineopilotWorkspaceLocation::Local(_, _) => {
                                    Icon::new(IconName::Screen)
                                        .color(Color::Muted)
                                        .into_any_element()
                                }
                                SerialineopilotWorkspaceLocation::Ssh(_) => {
            ...
            .update(cx, |_, _, cx| {
                recent_projects_picker.update(cx, |picker, cx| {
                    ...
                    delegate.set_workspaces(vec![(
                        WorkspaceId::default(),
                        SerialineopilotWorkspaceLocation::from_local_paths(vec![path!(
                            "/test/path/"
                        )]),
                    )]);
                });
