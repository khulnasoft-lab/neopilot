        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .child(Label::new("Connect to context servers via the Model Context Protocol either via Neopilot extensions or directly.").color(Color::Muted)),
            )
            .children(
