...
use language_model::{
    ConfiguredModel, LanguageModelRequestMessage, MessageContent, NEOPILOT_CLOUD_PROVIDER_ID,
    RequestUsage,
};
use multi_buffer;
use project::Project;
...
impl MessageEditor {
    ...
    fn render_max_mode_toggle(&self, cx: &mut Context<Self>) -> Option<AnyElement> {
        ...
        let icon = if max_mode_enabled {
            IconName::NeopilotBurnModeOn
        } else {
            IconName::NeopilotBurnMode
        };
    ...
    fn render_usage_callout(&self, line_height: Pixels, cx: &mut Context<Self>) -> Option<Div> {
        ...
        let plan = user_store
            .current_plan()
            .map(|plan| match plan {
                Plan::Free => neopilot_llm_client::Plan::NeopilotFree,
                Plan::NeopilotPro => neopilot_llm_client::Plan::NeopilotPro,
                Plan::NeopilotProTrial => neopilot_llm_client::Plan::NeopilotProTrial,
            })
