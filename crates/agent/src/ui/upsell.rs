    ...
    fn preview(window: &mut Window, cx: &mut App) -> Option<AnyElement> {
        let examples = vec![
            single_example(
                ...
                Upsell::new(
                    "Upgrade to Neopilot Pro",
                    "Get unlimited access to AI features and more with Neopilot Pro. Unlock advanced AI capabilities and other premium features.",
                    "Upgrade Now",
                    Box::new(|_, _, _| {}),
                    Box::new(|_, _, _| {}),
                    Box::new(|_, _, _| {}),
