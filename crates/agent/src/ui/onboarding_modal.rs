...
impl AgentOnboardingModal {
    ...
    fn view_blog(&mut self, _: &ClickEvent, _: &mut Window, cx: &mut Context<Self>) {
        cx.open_url("http://neopilot.dev/blog/fastest-ai-code-editor");
        cx.notify();
...
impl Render for AgentOnboardingModal {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let base = v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .child(Headline::new("Agentic Editing in Neopilot").size(HeadlineSize::Large)),
            )
        ...
        let copy = "Neopilot now natively supports agentic editing, enabling fluid collaboration between humans and AI.";
