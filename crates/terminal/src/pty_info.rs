...
/// Fetches Neopilot-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, returns whether the Neopilot-relevant info has changed
