...
mod tests {
    ...
    fn test_parsing_valid_remote_urls() {
        let valid_urls = vec![
            (
                "https://github.com/octocat/neopilot.git",
                "https",
                "github.com",
                "/octocat/neopilot.git",
            ),
            (
                "git@github.com:octocat/neopilot.git",
                "ssh",
                "github.com",
                "/octocat/neopilot.git",
            ),
            (
                "org-000000@github.com:octocat/neopilot.git",
                "ssh",
                "github.com",
                "/octocat/neopilot.git",
            ),
            (
                "ssh://git@github.com/octocat/neopilot.git",
                "ssh",
                "github.com",
                "/octocat/neopilot.git",
            ),
            (
                "file:///path/to/local/neopilot",
                "file",
                "",
                "/path/to/local/neopilot",
            ),
        ];
