...
fn checkpoint_author_envs() -> HashMap<String, String> {
    HashMap::from_iter([
        ("GIT_AUTHOR_NAME".to_string(), "Neopilot".to_string()),
        (
            "GIT_AUTHOR_EMAIL".to_string(),
            "hi@neopilot.dev".to_string(),
        ),
        ("GIT_COMMITTER_NAME".to_string(), "Neopilot".to_string()),
        (
...
mod tests {
    ...
    fn test_branches_parsing() {
        ...
        let input = "*\0060964da10574cd9bf06463a53bf6e0769c5c45e\0\0refs/heads/neopilot-patches\0refs/remotes/origin/neopilot-patches\0\01733187470\0generated protobuf\n";
        assert_eq!(
            parse_branch_input(&input).unwrap(),
            vec![Branch {
                is_head: true,
                ref_name: "refs/heads/neopilot-patches".into(),
                upstream: Some(Upstream {
                    ref_name: "refs/remotes/origin/neopilot-patches".into(),
