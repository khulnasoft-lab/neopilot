...
use neopilot_actions::ExtensionCategoryFilter;
...
actions!(neopilot, [InstallDevExtension]);
...
pub fn init(cx: &mut App) {
    cx.observe_new(move |workspace: &mut Workspace, window, cx| {
        ...
        workspace
            .register_action(
                move |workspace, action: &neopilot_actions::Extensions, window, cx| {
    ...
    fn on_extension_installed(
            ...
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        neopilot_actions::theme_selector::Toggle {
        ...
        if !icon_themes.is_empty() {
            workspace
                .update(cx, |_workspace, cx| {
                    window.dispatch_action(
                        neopilot_actions::icon_theme_selector::Toggle {
                            ...
                            .when(!is_compatible, |upgrade_button| {
                                upgrade_button.disabled(true).tooltip({
                                    ...
                                    move |_, cx| {
                                        Tooltip::simple(
                                            format!(
                                                "v{version} is not compatible with this version of Neopilot.",
                                            ),
                                             cx,
                                        )
                                    }
        ...
        v_flex().children(self.upsells.iter().enumerate().map(|(ix, feature)| {
            let upsell = match feature {
                Feature::Git => FeatureUpsell::new(
                    "Neopilot comes with basic Git support. More Git features are coming in the future.",
                )
                .docs_url("https://neopilot.dev/docs/git"),
                Feature::OpenIn => FeatureUpsell::new(
                    "Neopilot supports linking to a source line on GitHub and others.",
                )
                .docs_url("https://neopilot.dev/docs/git#git-integrations"),
                Feature::Vim => FeatureUpsell::new("Vim support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/vim")
                ...
                Feature::LanguageBash => FeatureUpsell::new("Shell support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/bash"),
                Feature::LanguageC => FeatureUpsell::new("C support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/c"),
                Feature::LanguageCpp => FeatureUpsell::new("C++ support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/cpp"),
                Feature::LanguageGo => FeatureUpsell::new("Go support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/go"),
                Feature::LanguagePython => FeatureUpsell::new("Python support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/python"),
                Feature::LanguageReact => FeatureUpsell::new("React support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/typescript"),
                Feature::LanguageRust => FeatureUpsell::new("Rust support is built-in to Neopilot!")
                    .docs_url("https://neopilot.dev/docs/languages/rust"),
                Feature::LanguageTypescript => {
                    FeatureUpsell::new("Typescript support is built-in to Neopilot!")
                        .docs_url("https://neopilot.dev/docs/languages/typescript")
                }
            };
