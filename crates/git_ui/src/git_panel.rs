...
struct SerialineopilotGitPanel {
    width: Option<Pixels>,
}
...
impl GitPanel {
    ...
    fn update_scrollbar_properties(&mut self, _window: &mut Window, cx: &mut Context<Self>) {
        ...
        //
        // We should fix this. PR: https://github.com/khulnasoft-lab/neopilot/pull/19495
        ...
        self.pending_serialization = cx.background_spawn(
            async move {
                KEY_VALUE_STORE
                    .write_kvp(
                        GIT_PANEL_KEY.into(),
                        serde_json::to_string(&SerialineopilotGitPanel { width })?,
                    )
                    .await?;
                anyhow::Ok(())
            }
    ...
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let branch_selector_button = Button::new("branch-selector", truncated_branch_name)
            ...
            .tooltip(Tooltip::for_action_title(
                "Switch Branch",
                &neopilot_actions::git::Switch,
            ))
            .on_click(|_, window, cx| {
                window.dispatch_action(neopilot_actions::git::Switch.boxed_clone(), cx);
            });
        ...
        let branch_selector = PopoverMenu::new("popover-button")
            ...
            .trigger_with_tooltip(
                ...
                Tooltip::for_action_title("Switch Branch", &neopilot_actions::git::Switch),
            )
            .anchor(Corner::BottomLeft)
            .offset(gpui::Point {
                x: px(0.0),
    ...
    fn preview(_window: &mut Window, _cx: &mut App) -> Option<AnyElement> {
        ...
        fn custom(branch_name: &str, upstream: Option<UpstreamTracking>) -> Branch {
            Branch {
                ...
                upstream: upstream.map(|tracking| Upstream {
                    ref_name: format!("neopilot/{}", branch_name).into(),
                    tracking,
                }),
                most_recent_commit: Some(CommitSummary {
                    sha: "abc123".into(),
                        ...
                        vec![
                            ...
                            single_example(
                                ...
                                div()
                                    ...
                                    .overflow_hidden()
                                    .child(PanelRepoFooter::new_preview(
                                        SharedString::from("khulnasoft-lab-community-examples"),
...
mod tests {
    ...
    async fn test_entry_worktree_paths(cx: &mut TestAppContext) {
        ...
        fs.set_status_for_repo(
            Path::new(path!("/root/neopilot/.git")),
            &[
                (
        ...
        let project = Project::test(
            fs.clone(),
            [path!("/root/neopilot/crates/gpui").as_ref()],
            cx,
        )
        .await;
        let (workspace, cx) =
        ...
        pretty_assertions::assert_eq!(
            ...
            [
                ...
                GitListEntry::GitStatusEntry(GitStatusEntry {
                    abs_path: path!("/root/neopilot/crates/gpui/gpui.rs").into(),
                    repo_path: "crates/gpui/gpui.rs".into(),
                    status: StatusCode::Modified.worktree(),
                    staging: StageStatus::Unstaged,
                }),
                GitListEntry::GitStatusEntry(GitStatusEntry {
                    abs_path: path!("/root/neopilot/crates/util/util.rs").into(),
        ...
        //    worktree_roots,
        //    vec![
        //        Path::new(path!("/root/neopilot/crates/gpui")).into(),
        //        Path::new(path!("/root/neopilot/crates/util/util.rs")).into(),
        //    ]
        //);
        ...
        //                == Path::new(path!("/root/neopilot/crates/util/util.rs"))
        //        })
        //        .unwrap()
        //        .clone();
