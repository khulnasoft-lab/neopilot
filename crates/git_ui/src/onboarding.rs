...
impl GitOnboardingModal {
    ...
    fn view_blog(&mut self, _: &ClickEvent, _: &mut Window, cx: &mut Context<Self>) {
        cx.open_url("https://neopilot.dev/blog/git");
        cx.notify();
...
impl Render for GitOnboardingModal {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let copy = "First-class support for staging, committing, pulling, pushing, viewing diffs, and more. All without leaving Neopilot.";
