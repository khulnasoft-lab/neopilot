...
use client::{neopilot_urls, proto};
...
impl ContextEditor {
    ...
    fn render_notice(&self, cx: &mut Context<Self>) -> Option<AnyElement> {
        // This was previously gated behind the `neopilot-pro` feature flag. Since we
            ...
            Some(
                h_flex()
                    ...
                    .child(
                        h_flex()
                            .gap_3()
                            .child(Icon::new(IconName::NeopilotAssistant).color(Color::Accent))
                            .child(Label::new(
                                "Neopilot AI is here! Get started by signing in →",
                            )),
                    )
                    .child(
                            ...
                            .on_click({
                                ...
                                move |_event, window, cx| {
                                    focus_handle.dispatch_action(
                                        &neopilot_actions::agent::OpenConfiguration,
                                        window,
                                        cx,
                                    );
                                }
