...
use neopilot_actions::{ExtensionCategoryFilter, Extensions};
...
fn toggle_theme_selector(
    ...
    toggle: &neopilot_actions::theme_selector::Toggle,
    window: &mut Window,
...
fn toggle_icon_theme_selector(
    workspace: &mut Workspace,
    toggle: &neopilot_actions::icon_theme_selector::Toggle,
    window: &mut Window,
    cx: &mut Context<Workspace>,
) {
    let fs = workspace.app_state().fs.clone();
                ...
                .child(
                    Button::new("docs", "View Theme Docs")
                        ...
                        .on_click(cx.listener(|_, _, _, cx| {
                            cx.open_url("https://neopilot.dev/docs/themes");
                        })),
                )
                .child(
