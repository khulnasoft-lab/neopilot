                ...
                MessageContent::ToolResult(tool_result) => {
                    let content = match &tool_result.content {
                        ...
                        LanguageModelToolResultContent::Image(_) => {
                            ...
                            "[Tool responded with an image, but Neopilot doesn't support these in Mistral models yet]".to_string()
                        }
                    };
    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use Neopilot's assistant with Mistral, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                ...
                .child(
                    Label::new(
                        format!("You can also assign the {MISTRAL_API_KEY_VAR} environment variable and restart Neopilot."),
                    )
