...
pub struct AnthropicSettings {
    pub api_url: String,
    /// Extend Neopilot's list of Anthropic models.
...
pub struct AvailableModel {
    ...
    pub name: String,
    /// The model's name in Neopilot's UI, such as in the model selector dropdown menu in the assistant panel.
    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use Neopilot's assistant with Anthropic, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                ...
                .child(
                    Label::new(
                        format!("You can also assign the {ANTHROPIC_API_KEY_VAR} environment variable and restart Neopilot."),
                    )
