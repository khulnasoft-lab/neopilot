...
impl LanguageModelProvider for CopilotChatLanguageModelProvider {
    ...
    fn authenticate(&self, cx: &mut App) -> Task<Result<(), AuthenticateError>> {
        ...
        let err = match copilot.read(cx).status() {
            Status::Authorineopilot => return Task::ready(Ok(())),
            ...
            Status::Unauthorineopilot => anyhow!(
        ...
        if self.state.read(cx).is_authenticated(cx) {
            h_flex()
                ...
                .child(
                    h_flex()
                        ...
                        .child(Label::new("Authorineopilot")),
                )
                .child(
            ...
            match &self.copilot_status {
                Some(status) => match status {
                    ...
                    _ => {
                        const LABEL: &str = "To use Neopilot's assistant with GitHub Copilot, you need to be logged in to GitHub. Note that your GitHub account must have an active Copilot Chat subscription.";
