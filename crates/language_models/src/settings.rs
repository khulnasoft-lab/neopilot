...
use crate::provider::{
    ...
    cloud::{self, NeopilotDotDevSettings},
...
pub struct AllLanguageModelSettings {
    ...
    pub neopilot_dot_dev: NeopilotDotDevSettings,
...
pub struct AllLanguageModelSettingsContent {
    ...
    pub neopilot_dot_dev: Option<NeopilotDotDevSettingsContent>,
...
#[derive(Default, Clone, Debug, Serialize, Deserialize, PartialEq, JsonSchema)]
pub struct NeopilotDotDevSettingsContent {
...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn load(sources: SettingsSources<Self::FileContent>, _: &mut App) -> Result<Self> {
        ...
        for value in sources.defaults_and_customizations() {
            ...
            merge(
                &mut settings.neopilot_dot_dev.available_models,
                value
                    .neopilot_dot_dev
                    .as_ref()
