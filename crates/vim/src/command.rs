...
use neopilot_actions::{OpenDocs, RevealTarget};
...
fn generate_commands(_: &App) -> Vec<VimCommand> {
    vec![
        ...
        VimCommand::new(("cq", "uit"), neopilot_actions::Quit),
        ...
        VimCommand::str(("opt", "ions"), "neopilot::OpenDefaultSettings"),
...
impl OnMatchingLines {
    // convert a vim query into something more usable by neopilot.
