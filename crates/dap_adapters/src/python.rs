...
impl PythonDebugAdapter {
    ...
    fn request_args(
        ...
        if let Ok(console) = configuration.dot_get_mut("console") {
            // Use built-in Neopilot terminal if user did not explicitly provide a setting for console.
            if console.is_null() {
...
impl DebugAdapter for PythonDebugAdapter {
    ...
    fn config_from_neopilot_format(
        &self,
        neopilot_scenario: NeopilotDebugConfig,
    ) -> Result<DebugScenario> {
        let mut args = json!({
            "request": match neopilot_scenario.request {
        ...
        match &neopilot_scenario.request {
            ...
            DebugRequest::Launch(launch) => {
                ...
                if let Some(stop_on_entry) = neopilot_scenario.stop_on_entry {
        ...
        Ok(DebugScenario {
            adapter: neopilot_scenario.adapter,
            label: neopilot_scenario.label,
            config: args,
            build: None,
            tcp_connection: None,
        })
            ...
            "properties": {
                ...
                "pathMappings": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            "localRoot": {
                                "default": "${NEOPILOT_WORKTREE_ROOT}",
                ...
                },
                {
                    ...
                    "then": {
                        "properties": {
                            ...
                            "envFile": {
                                "default": "${NEOPILOT_WORKTREE_ROOT}/.env",
