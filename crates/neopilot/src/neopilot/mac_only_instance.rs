...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Neopilot Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Neopilot Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Neopilot Editor Preview Instance Running",
        ReleaseChannel::Stable => "Neopilot Editor Stable Instance Running",
    }
}
