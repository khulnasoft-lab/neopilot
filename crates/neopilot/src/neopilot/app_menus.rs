...
pub fn app_menus() -> Vec<Menu> {
    use neopilot_actions::Quit;

    vec![
        Menu {
            name: "Neopilot".into(),
            items: vec![
                MenuItem::action("About Neopilot…", neopilot_actions::About),
                ...
                MenuItem::submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action("Open Key Bindings", neopilot_actions::OpenKeymap),
                        MenuItem::action("Open Default Settings", super::OpenDefaultSettings),
                        MenuItem::action(
                            "Open Default Key Bindings",
                            neopilot_actions::OpenDefaultKeymap,
                        ),
                        MenuItem::action("Open Project Settings", super::OpenProjectSettings),
                        MenuItem::action(
                            "Select Theme...",
                            neopilot_actions::theme_selector::Toggle::default(),
                        ),
                    ],
                }),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", neopilot_actions::Extensions::default()),
                MenuItem::action("Install CLI", install_cli::Install),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Neopilot", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Neopilot", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            items: vec![
                ...
                MenuItem::action(
                    "Open Recent...",
                    neopilot_actions::OpenRecent {
                        create_new_window: true,
                    },
                ),
                MenuItem::action(
                    "Open Remote...",
                    neopilot_actions::OpenRemote {
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Zoom In",
                    neopilot_actions::IncreaseBufferFontSize { persist: true },
                ),
                MenuItem::action(
                    "Zoom Out",
                    neopilot_actions::DecreaseBufferFontSize { persist: true },
                ),
                MenuItem::action(
                    "Reset Zoom",
                    neopilot_actions::ResetBufferFontSize { persist: true },
                ),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Command Palette...",
                    neopilot_actions::command_palette::Toggle,
                ),
                MenuItem::separator(),
                ...
                MenuItem::action(
                    ...
                    neopilot_actions::outline::ToggleOutline,
                ),
        ...
        Menu {
            name: "Help".into(),
            items: vec![
                MenuItem::action("View Telemetry", neopilot_actions::OpenTelemetryLog),
                MenuItem::action("View Dependency Licenses", neopilot_actions::OpenLicenses),
                MenuItem::action("Show Welcome", workspace::Welcome),
                MenuItem::action("Give Feedback...", neopilot_actions::feedback::GiveFeedback),
                MenuItem::separator(),
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://neopilot.dev/docs".into(),
                    },
                ),
                MenuItem::action(
                    "Neopilot Twitter",
                    super::OpenBrowser {
                        url: "https://twitter.com/neopilotdotdev".into(),
                    },
                ),
                MenuItem::action(
                    "Join the Team",
                    super::OpenBrowser {
                        url: "https://neopilot.dev/jobs".into(),
                    },
                ),
            ],
        },
