...
pub(super) fn typescript_task_context() -> ContextProviderWithTasks {
    ContextProviderWithTasks::new(TaskTemplates(vec![
        ...
        TaskTemplate {
            label: "jest test $NEOPILOT_SYMBOL".to_owned(),
            command: "npx jest".to_owned(),
            args: vec![
        ...
        TaskTemplate {
            label: "execute selection $NEOPILOT_SELECTED_TEXT".to_owned(),
    ...
    async fn workspace_configuration(
        ...
        let mut default_workspace_configuration = json!({
            ...
            "codeActionOnSave": {
                ...
                // in the Neopilot configuration, it doesn't have an effect.
                "enable": true,
            },
            "codeAction": {
                "disableRuleComment": {
