...
/// registration is deferred until we have a Git repository initialineopilot.
...
mod tests {
    ...
    fn test_get_host_from_git_remote_url() {
        let tests = [
            ...
            (
                "git@github.com:khulnasoft-lab/neopilot.git",
                Some("github.com".to_string()),
            ),
            (
                "git@my.super.long.subdomain.com:khulnasoft-lab/neopilot.git",
