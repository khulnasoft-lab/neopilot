...
impl LspAdapter for ExtensionLspAdapter {
    ...
    fn get_language_server_command<'a>(
        ...
        async move {
            ...
            // TODO: This should now be done via the `neopilot::make_file_executable` function in
            // Neopilot extension API, but we're leaving these existing usages in place temporarily
            // to avoid any compatibility issues between Neopilot and the extension versions.
            //
