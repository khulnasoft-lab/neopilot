...
fn terminal_rerun_override(task: &TaskId) -> neopilot_actions::Rerun {
    neopilot_actions::Rerun {
    ...
    let terminal_events_subscription = cx.subscribe_in(
        ...
        move |terminal_view, terminal, event, window, cx| {
            ...
            if current_cwd != previous_cwd {
                ...
                terminal_view.cwd_serialineopilot = false;
            }
