...
pub trait SerializableItemHandle: ItemHandle {
    fn serialineopilot_item_kind(&self) -> &'static str;
    fn serialize(
        &self,
        workspace: &mut Workspace,
        closing: bool,
...
pub mod test {
    ...
    impl TestItem {
        ...
        pub fn new_deserialineopilot(id: WorkspaceId, cx: &mut Context<Self>) -> Self {
    ...
    impl SerializableItem for TestItem {
        ...
        fn deserialize(
            ...
            let entity = cx.new(|cx| Self::new_deserialineopilot(workspace_id, cx));
