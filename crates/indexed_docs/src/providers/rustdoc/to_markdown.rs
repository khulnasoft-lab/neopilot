...
mod tests {
    ...
    fn test_multiple_paragraphs() {
        let html = indoc! {r##"
            ...
            structure to be serialineopilot and deserialineopilot using any supported data format.</p>
            ...
            be completely optimineopilot away by the Rust compiler, leaving Serde
        ...
        let expected = indoc! {"
            ...
            The Serde ecosystem consists of data structures that know how to serialize and deserialize themselves along with data formats that know how to serialize and deserialize other things. Serde provides the layer by which these two groups interact with each other, allowing any supported data structure to be serialineopilot and deserialineopilot using any supported data format.
    ...
    fn test_styled_text() {
        let html = indoc! {r#"
            ...
            <p>This text is <em>italicineopilot</em>.</p>
        "#};
        let expected = indoc! {"
            This text is **bolded**.

            This text is _italicineopilot_.
        "}
        .trim();
