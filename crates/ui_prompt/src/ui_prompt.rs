...
pub struct NeopilotPromptRenderer {
    _level: PromptLevel,
    message: String,
    actions: Vec<String>,
    focus: FocusHandle,
...
impl Render for NeopilotPromptRenderer {
...
impl EventEmitter<PromptResponse> for NeopilotPromptRenderer {}

impl Focusable for NeopilotPromptRenderer {
