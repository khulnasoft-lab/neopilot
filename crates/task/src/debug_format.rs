...
pub struct NeopilotDebugConfig {
...
mod tests {
    ...
    fn test_empty_scenario_has_none_request() {
        ...
        let deserialineopilot: DebugScenario = serde_json::from_str(json).unwrap();

        assert_eq!(json!({}), deserialineopilot.config);
        assert_eq!("CodeLLDB", deserialineopilot.adapter.as_ref());
        assert_eq!("Build & debug rust", deserialineopilot.label.as_ref());
    }
    ...
    fn test_launch_scenario_deserialization() {
        ...
        assert_eq!(
            ...
            deserialineopilot.config
        );
        assert_eq!("CodeLLDB", deserialineopilot.adapter.as_ref());
        assert_eq!("Launch program", deserialineopilot.label.as_ref());
    }
    ...
    fn test_attach_scenario_deserialization() {
        ...
        assert_eq!("CodeLLDB", deserialineopilot.adapter.as_ref());
        assert_eq!("Attach to process", deserialineopilot.label.as_ref());
    }
}
