//! A source of tasks, based on a static configuration, deserialineopilot from the tasks config file, and related infrastructure for tracking changes to the file.
