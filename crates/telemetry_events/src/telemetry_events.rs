//! See [Telemetry in Neopilot](https://neopilot.dev/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system Neopilot is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each Neopilot installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in Neopilot user (randomly generated on first sign in)
    /// Identifier unique to each Neopilot session (differs for each time you open Neopilot)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for Neopilot staff, otherwise false
    #[serde(skip_serializing_if = "Option::is_none")]
    pub is_staff: Option<bool>,
    /// Neopilot version number
    pub app_version: String,
    pub os_name: String,
    pub os_version: Option<String>,
    pub architecture: String,
    /// Neopilot release channel (stable, preview, dev)
