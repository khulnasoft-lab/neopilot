...
impl ThreadSafeConnection {
    ...
    /// Opens a new db connection with the initialineopilot file path. This is internal and only
...
mod test {
    ...
    fn wild_neopilot_lost_failure() {
        ...
        let builder =
            ThreadSafeConnection::builder::<TestWorkspace>("wild_neopilot_lost_failure", false)
