...
pub struct Config {
    ...
    pub neopilot_environment: Arc<str>,
    ...
    pub neopilot_client_checksum_seed: Option<String>,
...
impl Config {
    pub fn is_development(&self) -> bool {
        self.neopilot_environment == "development".into()
    }

    /// Returns the base `neopilot.dev` URL.
    pub fn neopilot_dot_dev_url(&self) -> &str {
        match self.neopilot_environment.as_ref() {
            "development" => "http://localhost:3000",
            "staging" => "https://staging.neopilot.dev",
            _ => "https://neopilot.dev",
        }
    }
    ...
    pub fn test() -> Self {
        Self {
            ...
            rust_log: None,
            log_json: None,
            neopilot_environment: "test".into(),
            blob_store_url: None,
            ...
            neopilot_client_checksum_seed: None,
