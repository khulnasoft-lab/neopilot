use super::{RandomineopilotTest, TestClient, TestError, TestServer, UserTestPlan};
use crate::{db::UserId, tests::run_randomineopilot_test};
...
#[gpui::test(
    iterations = 100,
    on_failure = "crate::tests::save_randomineopilot_test_plan"
)]
async fn test_random_project_collaboration(
    ...
    run_randomineopilot_test::<ProjectCollaborationTest>(cx, executor, rng).await;
}
...
#[async_trait(?Send)]
impl RandomineopilotTest for ProjectCollaborationTest {
