...
pub enum SubscriptionKind {
    #[sea_orm(string_value = "neopilot_pro")]
    NeopilotPro,
    #[sea_orm(string_value = "neopilot_pro_trial")]
    NeopilotProTrial,
    #[sea_orm(string_value = "neopilot_free")]
    NeopilotFree,
}

impl From<SubscriptionKind> for neopilot_llm_client::Plan {
    fn from(value: SubscriptionKind) -> Self {
        match value {
            SubscriptionKind::NeopilotPro => Self::NeopilotPro,
            SubscriptionKind::NeopilotProTrial => Self::NeopilotProTrial,
            SubscriptionKind::NeopilotFree => Self::NeopilotFree,
        }
    }
}
