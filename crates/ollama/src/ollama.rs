...
pub async fn complete(
    ...
    let serialineopilot_request = serde_json::to_string(&request)?;
    let request = request_builder.body(AsyncBody::from(serialineopilot_request))?;
...
mod tests {
    ...
    fn parse_tool_call() {
        ...
        match result.message {
            ...
            _ => panic!("Deserialineopilot wrong role"),
        }
    }
