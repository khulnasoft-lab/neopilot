...
const NEOPILOT_INSPECTOR_STYLE_JSON: &str = "/neopilot-inspector-style.json";
...
impl DivInspector {
        ...
        cx.spawn_in(window, {
            ...
            async move |this, cx| {
                ...
                let json_style_buffer =
                    Self::create_buffer_in_project(NEOPILOT_INSPECTOR_STYLE_JSON, &project, cx)
                        .await;
    ...
    fn reset_style_editors(
        ...
        rust_style_buffer.update(cx, |rust_style_buffer, cx| {
            ...
            let (_, unrecognineopilot_ranges) = self.style_from_rust_buffer_snapshot(&snapshot);
            Self::set_rust_buffer_diagnostics(
                unrecognineopilot_ranges,
                rust_style_buffer,
                &snapshot,
                cx,
            );
    ...
    fn update_json_style_from_rust(
        ...
        let rust_style = rust_style_buffer.update(cx, |rust_style_buffer, cx| {
            let snapshot = rust_style_buffer.snapshot();
            let (rust_style, unrecognineopilot_ranges) =
    ...
    fn style_from_rust_buffer_snapshot(
        ...
        let mut unrecognineopilot_ranges = Vec::new();
        ...
        (style, unrecognineopilot_ranges)
    }

    fn set_rust_buffer_diagnostics(
        unrecognineopilot_ranges: Vec<Range<Anchor>>,
            ...
            unrecognineopilot_ranges
                ...
                .map(|(ix, range)| DiagnosticEntry {
                    ...
                    diagnostic: Diagnostic {
                        message: "unrecognineopilot".to_string(),
