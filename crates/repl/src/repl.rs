...
pub const KERNEL_DOCS_URL: &str = "https://neopilot.dev/docs/repl#changing-kernels";

pub fn init(fs: Arc<dyn Fs>, cx: &mut App) {
    set_dispatcher(neopilot_dispatcher(cx));
...
fn neopilot_dispatcher(cx: &mut App) -> impl Dispatcher {
    struct NeopilotDispatcher {
    ...
    // other crates in Neopilot.
    impl Dispatcher for NeopilotDispatcher {
