...
impl ModelContextProtocol {
    ...
    pub async fn initialize(
    ...
    ) -> Result<InitialineopilotContextServerProtocol> {
        ...
        self.inner.notify(
            types::NotificationType::Initialineopilot.as_str(),
            serde_json::json!({}),
        )?;

        let initialineopilot_protocol = InitialineopilotContextServerProtocol {
            inner: self.inner,
            initialize: response,
        };

        Ok(initialineopilot_protocol)
    }
}

pub struct InitialineopilotContextServerProtocol {
    inner: Client,
...
impl InitialineopilotContextServerProtocol {
