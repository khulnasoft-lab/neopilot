use neopilot_extension_api::{
    self as neopilot, SlashCommand, SlashCommandArgumentCompletion, SlashCommandOutput,
    SlashCommandOutputSection, Worktree,
};

struct SlashCommandsExampleExtension;

impl neopilot::Extension for SlashCommandsExampleExtension {
    fn new() -> Self {
    ...
    fn complete_slash_command_argument(
        ...
        _args: Vec<String>,
    ) -> Result<Vec<neopilot_extension_api::SlashCommandArgumentCompletion>, String> {
...
neopilot::register_extension!(SlashCommandsExampleExtension);
