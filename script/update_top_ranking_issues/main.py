...
def main(
    ...
    repo_name: str = "khulnasoft-lab/neopilot"
...
def get_issue_text(
    ...
    issue_text_lines: list[str] = [
        ...
        *highest_ranking_issues_lines,
        "\n---\n",
        "*For details on how this issue is generated, [see the script](https://github.com/khulnasoft-lab/neopilot/blob/main/script/update_top_ranking_issues/main.py)*",
    ]
