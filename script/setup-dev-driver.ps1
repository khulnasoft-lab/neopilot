...
$Volume = New-VHD -Path C:/neopilot_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/neopilot_dev_drive.vhdx
Mount-VHD -Path C:/neopilot_dev_drive.vhdx
...
Write-Output `
	...
	"NEOPILOT_WORKSPACE=$($Drive)/neopilot" `
